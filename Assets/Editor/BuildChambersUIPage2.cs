...
public class BuildChambersUIPage2
{
    public static void Build()
    {
        ...
        foreach(var r in roots) {
            Transform[] all = r.GetComponentsInChildren<Transform>(true);
            foreach(var t in all) if(t.name == "Page_Content_Area") parent = t.gameObject;
        }

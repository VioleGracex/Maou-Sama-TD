...
{
    public class SwiftSelectPopup : EditorWindow
    {
        ...
        public static void ShowPopup(Vector2 position, List<GameObject> objects, bool multiSelect)
        {
            ...
            SwiftSelectPopup window = CreateInstance<SwiftSelectPopup>();
        ...
        private void UpdateFilteredList()
        {
            ...
            if (SwiftSelectSettings.ShowOnlyActive)
            {
        ...
        private void OnGUI()
        {
            ...
            {
                if (_allObjects != null && !SwiftSelectSettings.ShowOnlyActive)
                {
            ...
            bool onlyActive = EditorGUILayout.ToggleLeft("Active Only", SwiftSelectSettings.ShowOnlyActive);
            if (EditorGUI.EndChangeCheck())
            {
                SwiftSelectSettings.ShowOnlyActive = onlyActive;
                UpdateFilteredList();
            }
            ...
            for (int i = 0; i < _filteredObjects.Count; i++)
            {
                ...
                if (isSelected || itemRect.Contains(Event.current.mousePosition) || isActualSelected)
                {
                    ...
                    {
                        _selectedIndex = i;
                        SwiftSelectManager.SetHoverHighlight(obj);
                    }
                }

                // Draw content
                GUIContent content = EditorGUIUtility.ObjectContent(obj, typeof(GameObject));
                if (!SwiftSelectSettings.ShowIcons) content.image = null;
        ...
        {
            SwiftSelectManager.SetHoverHighlight(null);
        }
        ...
        private void SelectObject(GameObject obj)
        {
            ...
            if (SwiftSelectSettings.FocusOnSelect)
            {

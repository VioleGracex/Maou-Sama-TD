...
{
    /// <summary>
    /// Manager for session-based battle currency (Authority Seals).
    /// Does NOT persist Gold or Blood Crests.
    /// </summary>
    public class BattleCurrencyManager : MonoBehaviour
    {
        public static BattleCurrencyManager Instance { get; private set; }
        ...
        public void SetSeals(int amount)
        {
            ...
            OnSealsChanged?.Invoke(CurrentSeals);
            Debug.Log($"[BattleCurrencyManager] Seals set to {CurrentSeals}.");
        }

    ...
    public class GachaBannerEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("DESIGNER SPECIFICATIONS:\n" +
                                    "• Tab Image: 200 x 100 (2:1 Ratio)\n" +
                                    "• Banner Image: 1024 x 768 (4:3 Ratio)\n" +
                                    "• Full Banner Card Panel: 1450 x 768 (~1.89:1 Wide)", MessageType.Info);
        ...
        private void DrawTabImagePreview(GachaBannerSO banner)
        {
            if (banner.TabImage != null)
            {
                ...
                Rect rect = GUILayoutUtility.GetRect(EditorGUIUtility.currentViewWidth, 100);

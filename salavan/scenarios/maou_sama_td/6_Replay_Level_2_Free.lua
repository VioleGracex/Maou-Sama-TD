-- Scenario 6: Replay Level 2 (Free Play)
-- Flow: connect/launch game (no clear data) → navigate Conquest map → select Level 2 node → Engage → Start Mission → Start Battle → Deploy Ignis → Ultimate → Level 2 victory.
...
local function run_tests()
    ...
    -- Bypassing tutorial popup if any
